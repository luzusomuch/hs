...
let Language = {
	...
	de: {
		...
		USERNAME_EMAIL: 'Nutzername oder Emailadresse',
		...
		INVITE_FRIEND: 'Freunde einalden',
		...
		REPLY: 'wiederholen',
		EXHIBIT: 'Exhibit',
		GRANTED_AWARDS: 'Alle Auszeichnunge',
		...
		APPLY: 'übernehmen',
		REJECT: 'absagen',
		ACCEPTED: 'Für jeden User der diesen Event beitritt',
		GPS: 'For every users who has signal from Healthstars Apps',
		ORGANIZER: 'This award will be granted by organizer',
		OFFLINE: 'This award will be granted offline',
		ACCOUNT_INFORMATION: 'Account Information',
		...
		MINUTES_AGO: 'vor einigen Minuten',
