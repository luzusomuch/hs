...
let Language = {
	en : {
		...
		NUMBER: 'Number',
		MIN_NUMBER: 'Minimun number',
		MAX_NUMBER: 'Maximun number',
		PARTICIPANTS_LIMITATIONS: 'Participants limitations',
		NUMBER_OF_PARTICIPANTS_DID_NOT_REACH_MINIMUM_PARTICIPANTS: 'Number of participants did not reach minimum participants',
	...
	de: {
		...
		NUMBER: 'Anzahl',
		MIN_NUMBER: 'Minimale teilnehmerzahl',
		MAX_NUMBER: 'Maximale teilnehmerzahl',
		PARTICIPANTS_LIMITATIONS: 'Teilnehmer Einschränkungen',
		NUMBER_OF_PARTICIPANTS_DID_NOT_REACH_MINIMUM_PARTICIPANTS: 'Anzahl der Teilnehmer erreichte keine Mindestteilnehmer',
